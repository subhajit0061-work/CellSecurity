...
public class SOS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sos); //This activity linked to "activity_main.xml" - design of activity. ("AndroidManifest.xml" updated with second activity")
        ...
        SOS_Button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (checkPermission(Manifest.permission.SEND_SMS) && locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                    new SendSms().send(SOS.this, preferences);
...
//                    String smsMessage = "EMERGENCY!!! This is an emergency message from cell security application for user "+preferences.getString("name","")+"!. \n\nTheir location is: https://www.google.com/maps/search/?api=1&query=" + location;
...
//                        }
//                    }
                    Toast.makeText(SOS.this, "SMS Alerts Sent!", Toast.LENGTH_SHORT).show(); //Toast (message) displayed: SMS alerts successfully sent
                ...
                //If either SMS and Location permissions denied then do the following...
                    ...
                    Toast.makeText(SOS.this, "SMS Alerts NOT Sent!", Toast.LENGTH_SHORT).show(); //Toast (message) displayed: SMS alerts NOT sent i.e. re-enable and re-try
                }
            }
        });
    }
    ...
    private String getLocation() {
        ...
        if (ActivityCompat.checkSelfPermission(SOS.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED &&
                ActivityCompat.checkSelfPermission(SOS.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
