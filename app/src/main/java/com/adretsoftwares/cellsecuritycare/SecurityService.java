...
public class SecurityService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent i1=new Intent(SecurityService.this,WrongPinPassPatternMode.class);
        /**
        ...
        PendingIntent pendingIntent=PendingIntent.getActivity(this,0,i1,PendingIntent.FLAG_MUTABLE);
        /**
